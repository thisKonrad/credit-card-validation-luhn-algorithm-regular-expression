/* ::$:: credit_card_validation_ SCRIPT.js ::$:: */
...
expMonth.addEventListener('click', ()=>{
    ...
    if(expYear.selectedIndex < 1 && expMonth.selectedIndex <= validDateMonth){
...
/** validate the cvv / cvc number against a regular expression number 
...
/* :: validate the choosen card number against the matching regular expression :: */
